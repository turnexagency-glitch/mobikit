...
const brandData: Record<string, { name: string; tagline: string; country: string; description: string }> = {
  ...
  'esteban': { name: 'Esteban Paris', tagline: 'Parfums & Senteurs d\'Intérieur', country: 'France · Paris', description: 'Maison de parfums d\'intérieur parisienne, Esteban crée des fragrances raffinées pour sublimer votre espace de vie.' },
  'esteban-paris': { name: 'Esteban Paris', tagline: 'Parfums & Senteurs d\'Intérieur', country: 'France · Paris', description: 'Maison de parfums d\'intérieur parisienne, Esteban crée des fragrances raffinées pour sublimer votre espace de vie.' },
